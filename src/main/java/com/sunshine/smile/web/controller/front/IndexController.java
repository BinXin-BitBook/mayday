package com.sunshine.smile.web.controller.front;
...
import com.sunshine.smile.model.domain.Article;
import com.sunshine.smile.model.domain.ArticleCustom;
import com.sunshine.smile.model.domain.Category;
import com.sunshine.smile.model.domain.Link;
import com.sunshine.smile.model.domain.Tag;
import com.sunshine.smile.model.dto.ArchiveBo;
import com.sunshine.smile.model.dto.SmileConst;
import com.sunshine.smile.model.enums.ArticleStatus;
import com.sunshine.smile.model.enums.PageNumber;
import com.sunshine.smile.model.enums.PostType;
import com.sunshine.smile.service.ArticleService;
import com.sunshine.smile.service.CategoryService;
import com.sunshine.smile.service.LinksService;
import com.sunshine.smile.service.TagService;
import com.sunshine.smile.util.SmileUtil;
import com.sunshine.smile.web.controller.admin.BaseController;
...
public class IndexController extends BaseController {
	...
	public String index(Model model, @PathVariable(value = "page") Integer page) {
		page = page < 0 || page > SmileConst.MAX_PAGE ? 1 : page;
		// 默认显示条数
		Integer limit = StrUtil.isEmpty(SmileConst.OPTIONS.get("index_article")) ? PageNumber.POST_INDEX_lIMIT.getLimit()
				: Integer.parseInt(SmileConst.OPTIONS.get("index_article"));
	...
	public boolean checkRepeatIp(HttpServletRequest request, int id) {
		...
		cache.hset("hits:frequency", value, 1, SmileConst.IP_REPEAT_TIME);
		return false;
	}
	...
	public void updateArticleViews(Integer id, Long views) {
		...
		if (cacheViews >= SmileConst.CLICK_EXCEED) {
	...
	public String rss() throws FeedException {
		String rssNumber = SmileConst.OPTIONS.get("rss_number");
		...
		return SmileUtil.buildRss(articles);
	}
