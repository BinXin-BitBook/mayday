...
public class SmileUtil {
	...
	public static String buildRss(List<ArticleCustom> articles)throws FeedException{
		 ...
		 if(SmileConst.OPTIONS.get("blog_name")==null) {
			 channel.setTitle("");
		 }else {
			 channel.setTitle(SmileConst.OPTIONS.get("blog_name"));
		 }
		 if(SmileConst.OPTIONS.get("blog_url")==null) {
			 channel.setLink("");
		 }else {
			 channel.setLink(SmileConst.OPTIONS.get("blog_url"));
		 }
		 if(SmileConst.OPTIONS.get("blog_url")==null) {
			 channel.setUri("");
		 }else {
			 channel.setUri(SmileConst.OPTIONS.get("blog_url"));
		 }
		 if(SmileConst.OPTIONS.get("seo_describe")==null) {
			 channel.setDescription("");
		 }else {
			 channel.setDescription(SmileConst.OPTIONS.get("seo_describe"));
		 }
		...
		for (int i = 0; i < articles.size(); i++) {
			...
			item.setLink(SmileConst.OPTIONS.get("blog_url")+"/post/"+articles.get(i).getArticleUrl());
