...
import com.sunshine.smile.web.interceptor.IndexInterceptor;
import com.sunshine.smile.web.interceptor.InstallInterceptor;
import com.sunshine.smile.web.interceptor.LoginInterceptor;
...
public class WebMvcConfig implements WebMvcConfigurer {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/upload/**").addResourceLocations("classpath:/upload/")
				.addResourceLocations("file:///" + System.getProperties().getProperty("user.home") + "/smile/upload/");
